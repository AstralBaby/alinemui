...
var require_resolveConfig = __commonJS({
  "node_modules/tailwindcss/lib/util/resolveConfig.js"(exports) {
    ...
    function mergeExtensions({ extend: extend2, ...theme2 }) {
      return mergeWith(theme2, extend2, (themeValue, extensions) => {
  ...
  components: {
    ...
    MuiTabs: {
      ...
      styleOverrides: {
        ...
        flexContainer: ({ ownerState, theme: theme2 }) => ({
          "button": {
            minHeight: 0,
            "&.Mui-selected": returnIf(ownerState.variant, "contained", {
              background: theme2.palette.secondary.main,
